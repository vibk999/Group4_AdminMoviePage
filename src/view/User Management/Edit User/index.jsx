...
const {t}=useTranslation();
  const schema = yup.object().shape({
    ...
    email: yup.string().email(t("email is invalid")).required(t("This is  required!")),
    soDt: yup
      .string()
      .matches(/^[0-9]+$/)
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: 10 }}>
                <Typography className={classes.text} variant="h5">{t("UserName")}:</Typography>
                <TextField
            ...
            <div style={{ marginBottom: 10 }}>
              <Typography className={classes.text} variant="h5">{t("Password")}:</Typography>
              <TextField
            ...
            <div style={{ marginBottom: 10 }}>
              <Typography className={classes.text} variant="h5">{t("Email")}:</Typography>
              <TextField
                value={values.email}
                onChange={handleChange}
                onBlur={handleBlur}
            ...
            <div style={{ marginBottom: 10 }}>
              <Typography className={classes.text} variant="h5">{t("FullName")}:</Typography>
              <TextField
                value={values.hoTen}
                onChange={handleChange}
                onBlur={handleBlur}
            ...
            <div style={{ marginBottom: 10 }}>
              <Typography className={classes.text} variant="h5">{t("Phone")}</Typography>
              <TextField
                value={values.soDt}
                onChange={handleChange}
                onBlur={handleBlur}
            ...
            <div style={{ marginBottom: 10 }}>
            <Typography className={classes.text} variant="h6">{t("Group Code")}:</Typography>
              <NativeSelect
                value={values.maNhom}
                name="maNhom"
                fullWidth
            ...
            <div style={{ marginBottom: 10 }}>
            <Typography className={classes.text}  variant="h6">{t("User Type")}:</Typography>
              <NativeSelect
            ...
            <div className={classes.buttonLine}>
              <Button size="large" className={classes.button} type="submit" variant="contained" color="primary">
              {t("Edit User")}
              </Button>
            </div>
          </form>
